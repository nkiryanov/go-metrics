...
func TestStorage_ParseGauge(t *testing.T) {
...
func TestStorage_ParseCounter(t *testing.T) {
	type expected struct{
		value Counter
		isError	bool
	}
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got, err := ParseCounter(tc.toParse)
...
func TestStorage_ParseStorable(t *testing.T) {
	type expected struct {
		value Storable
		isError bool
	}
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got, err := ParseStorable(tc.fnArgs.mType, tc.fnArgs.value)
